...
class RewardTransaction(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    user_id = Column(Integer, ForeignKey("users.id"), nullable=False)
    action_type = Column(Enum(ActionType, name='actiontype', create_type=False), nullable=False)
...
class Badge(Base):
    ...
    badge_level = Column(Enum(BadgeLevel, name='badgelevel', create_type=False), nullable=False)
...
class RewardCatalog(Base):
    ...
    reward_type = Column(Enum(RewardType, name='rewardtype', create_type=False), nullable=False)
...
class RewardRedemption(Base):
    ...
    status = Column(Enum(RedemptionStatus, name='redemptionstatus', create_type=False), default=RedemptionStatus.PENDING, nullable=False)
